# Primeira Questão :Suponha que você tem duas tabelas: "Clientes" e "Pedidos". Crie uma consulta que liste todos os
...
# Segunda Questão : Você possui duas tabelas: "Departamentos" e "Funcionários". Alguns funcionários não estão
...
# Terceira Questão: Imagine que você tem duas tabelas: "Produtos" e "Vendas". Nem todos os produtos foram
